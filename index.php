...
$statement = $pdo->prepare("SELECT c.*, cat.nombre_categoria 
                           FROM curso c 
...
$statement = $pdo->prepare("SELECT c.*, cat.nombre_categoria, COUNT(i.idinscripcion) as total_inscripciones 
                           FROM curso c 
                           LEFT JOIN categoria cat ON c.idcategoria = cat.idcategoria 
...
<?php if($certificados_activos == 1): ?>
<!-- Inicio de la sección de cursos -->
<?php endif; ?>
...
<section class="recent-courses py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="section-title">Cursos Recientes</h2>
            </div>
        </div>
        <div class="row">
            <?php foreach($cursos_recientes as $curso): ?>
            <div class="col-md-4">
                <div class="course-card">
                    ...
                    <a href="curso.php?id=<?php echo $curso['idcurso']; ?>" class="btn btn-primary">Ver Detalles</a>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
