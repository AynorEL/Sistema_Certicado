...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['cust_email'])) {
        $valid = 0;
        $error_message .= "El correo electrónico es requerido.\\n";
    } else {
    ...
    if($valid == 1) {
        ...
        $message = '<p>Se ha enviado un correo electrónico con un enlace para restablecer su contraseña.<br> <a href="'.BASE_URL.'reset-password.php?email='.$_POST['cust_email'].'&token='.$token.'">Haga clic aquí</a>';
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for=""><?php echo "Correo electrónico *"; ?></label>
                                    <input type="email" class="form-control" name="cust_email">
                                </div>
                                <div class="form-group">
                                    <label for=""></label>
                                    <input type="submit" class="btn btn-primary" value="Enviar" name="form1">
                                </div>
                                <a href="login.php" style="color:#e4144d;"><?php echo "Iniciar sesión"; ?></a>
                            </div>
                        </div>                        
                    </form>
                </div>                
